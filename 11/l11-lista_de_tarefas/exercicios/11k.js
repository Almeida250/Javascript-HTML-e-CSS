//quando carregar a página, ele vai salvar as listas no localStorage
const listaTarefa = JSON.parse(localStorage.getItem('listaTarefa')) || [
  {nome: 'Ir ao mercado',
   data: '01-01-2025' }
];
  ...
  for (let i = 0; i < listaTarefa.length; i++) {
    ...
    const html = ` 
      ...
      <button onclick="
        ...
        //quando att a lista, salvar no localStorage
